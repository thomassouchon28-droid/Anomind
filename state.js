/* state.js — État partagé de la partie (S), petits utilitaires (stockage local, identifiant de session) et fonctions dérivées en lecture seule (points d'une équipe, accès à un document, détenteur actif d'une équipe, conditions de fin de partie). Dépend de data.js. */
